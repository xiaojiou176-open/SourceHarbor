...
Use this page like a filled-out shipping envelope for the `MCP.so` lane.
...
| MCP.so field shape | SourceHarbor repo-owned source |
| --- | --- |
...
| homepage / repository / docs / issues | `config/public/mcp-directory-profile.json` |
