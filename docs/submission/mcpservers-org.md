# mcpservers.org Submission Packet

Use this page like a filled-out shipping envelope for the `mcpservers.org`
lane.
...
| mcpservers.org field shape | SourceHarbor repo-owned source |
| --- | --- |
