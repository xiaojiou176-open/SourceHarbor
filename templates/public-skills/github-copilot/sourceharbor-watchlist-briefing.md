# SourceHarbor Watchlist Briefing Template for GitHub Copilot

Use this public template when you want GitHub Copilot to inspect one
...
- `docs/builders.md`
- `starter-packs/github-copilot/README.md`
