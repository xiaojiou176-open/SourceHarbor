# SourceHarbor Watchlist Briefing Template for VS Code Agent Workflows

Use this public template when you want VS Code agent workflows to inspect one
SourceHarbor watchlist and answer a question with the current story context.
...
- `MCP_STATUS`: whether MCP is connected
...
- `docs/builders.md`
- `starter-packs/vscode-agent/README.md`
