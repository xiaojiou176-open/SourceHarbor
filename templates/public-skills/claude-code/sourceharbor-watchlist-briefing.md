# SourceHarbor Watchlist Briefing Template for Claude Code

Use this public template when you want Claude Code to inspect one
...
- `docs/builders.md`
- `starter-packs/claude-code/CLAUDE.md`
