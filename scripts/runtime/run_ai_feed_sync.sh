...
usage() {
  cat <<'EOF'
Usage: ./scripts/runtime/run_ai_feed_sync.sh [options]
...
Options:
  ...
  --api-base-url <url>              Override SOURCE_HARBOR_API_BASE_URL for this run
...
SOURCE_HARBOR_API_BASE_URL="$(resolve_route_value_local "SOURCE_HARBOR_API_BASE_URL" "$API_BASE_URL_OVERRIDE" "http://127.0.0.1:9000")"
...
exec python3 "$ROOT_DIR/scripts/runtime/sync_ai_feed_to_miniflux.py"
