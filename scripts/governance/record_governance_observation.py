...
def main() -> int:
    ...
    parser.add_argument(
        "--history-path", default=".runtime-cache/reports/governance/observation-history.jsonl"
    )
    ...
    print(
        f"[governance-observation] recorded kind={args.kind} status={args.status} run_id={run_id}"
    )
    return 0
