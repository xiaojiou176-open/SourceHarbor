...
DEFAULT_SUMMARY_PATH = Path(".runtime-cache/reports/web-coverage/coverage-summary.json")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Path to vitest coverage summary JSON. Default: .runtime-cache/reports/web-coverage/coverage-summary.json",
    )
    parser.add_argument(
        "--global-threshold",
        type=float,
    ...
    parser.add_argument(
        ...
        default=[],
        help=("Coverage metric to evaluate. Repeatable. Default: lines,functions,branches"),
    )
    parser.add_argument(
        "--core-pattern",
        action="append",
